...
class Edumy_Elementor_Features_Box extends Widget_Base {

	public function get_name() {
        return 'edumy_features_box';
    }

	public function get_title() {
        return esc_html__( 'Apus Features Box', 'edumy' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Features Box', 'edumy' ),
        ...
        $repeater->add_control(
            'image_icon',
            [
                'label' => esc_html__( 'Image or Icon', 'edumy' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'icon' => esc_html__('Icon', 'edumy'),
                    'image' => esc_html__('Image', 'edumy'),
                ),
                'default' => 'image'
            ]
        );
        ...
        $repeater->add_control(
            'title_text',
            [
                'label' => esc_html__( 'Title & Description', 'edumy' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'style1' => esc_html__('Style 1 (White)', 'edumy'),
...
Plugin::instance()->widgets_manager->register_widget_type( new Edumy_Elementor_Features_Box );