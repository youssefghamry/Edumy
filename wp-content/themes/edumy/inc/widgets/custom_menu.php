...
class Edumy_Custom_Menu extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_custom_menu',
            esc_html__('Apus Custom Menu Widget', 'edumy'),
            array( 'description' => esc_html__( 'Show custom menu', 'edumy' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $styles = array(
            ...
            esc_html__('Gray', 'edumy') => 'gray',
            esc_html__('White', 'edumy') => 'white'            
        );
        ?>
        <p>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>">
                <?php echo esc_html__('Menu:', 'edumy' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('style')); ?>">
                <?php echo esc_html__('Style:', 'edumy' ); ?>
            </label>
            <br>
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Edumy_Custom_Menu');
}